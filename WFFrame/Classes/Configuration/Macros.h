...
//弱引用/强引用  可配对引用在外面用WFWeakSelf(self)，block用WFStrongSelf(self)  也可以单独引用在外面用WFWeakSelf(self) block里面用weakself
#define WFWeakSelf(type)  __weak typeof(type) weak##type = type;
#define WFStrongSelf(type)  __strong typeof(type) type = weak##type;
